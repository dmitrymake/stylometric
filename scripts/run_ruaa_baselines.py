...
классика (Delta/char-cos/BoW) и полный stylo — одна таблица, одни фолды,
клaстер-робастная значимость против stylo уже внутри run_final. stylo_stack
запускается только явно через --specs как медленный калибровочный эксперимент.
...
Стек явно: --specs stylo,stylo_stack,delta:300,delta_cos:500,char_cos,bow_lr,majority
"""
...
DEFAULT_SPECS = ["stylo", "delta:300", "delta_cos:500",
