...
фиксированным набором меток. Точка macro-F1 0.8398 остаётся описательной. Accuracy устойчива к ресэмплингу
авторов: author-clustered CI [0.8116, 0.9366],
медиана 0.8826 ≈ точке 0.8805.
