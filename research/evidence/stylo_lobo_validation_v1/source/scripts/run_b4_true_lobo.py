#!/usr/bin/env python3
"""Run/resume the bounded 47-class B4 stylo A0/A4/A1 true-LOBO validation."""
...
from stylo.eval.b4_pilot import canonical_hash  # noqa: E402
from stylo.eval.b4_true_lobo import (  # noqa: E402
    CELL_ORDER,
    SCHEMA_VERSION,
    STATUS,
    build_run_identity,
...
def _git_metadata() -> tuple[str, bool]:
    ...
    # The true-LOBO implementation is intentionally uncommitted.  Unlike the preceding pilot,
    # this increment can consist entirely of new files, so omitting untracked paths would falsely
    # attest to a clean tree (the full runtime bytes remain independently bound by code_hashes).
...
def _runtime_fingerprint(cfg) -> tuple[dict[str, Any], dict[str, Any]]:
    import joblib
    import numpy as np
    import scipy
    import scipy.linalg
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run/resume the B4 47-class true-LOBO stylo A0/A4/A1 validation.")
