"""Delta / DeltaCos F×R four-corner grid, proven against independent references.
...
def test_delta_schema_migration_is_version_aware_and_fail_closed():
    ...
    # A schema-v3 artifact with _ablation STRIPPED is corrupt: A2 must not load as another corner.
