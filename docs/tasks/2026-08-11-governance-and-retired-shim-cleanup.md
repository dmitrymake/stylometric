...
- [x] AC-01 Ledger is the only mutable v3.2 status authority; protocol/catalog contain stable scope.
- [x] AC-02 Requirements explicitly distinguish historical v3.1 Holm-15 and current v3.2 16/11.
- [x] AC-03 All twelve selected shim files and their live topology entries are absent.
- [x] AC-04 Historical p0 hashes remain unchanged and validated.
- [x] AC-05 Canonical entrypoints and relevant governance/release regressions pass.
- [x] AC-06 Production LOC is at least 193 lines lower with no new production concepts/files.
- [x] AC-07 Evaluator/freeze/preflight/authorization/execution/publication state is unchanged.
...
- [x] DOD-07 through DOD-15 (`DOD-09` satisfied by the required clean-context deletion review)
- DOD-06 not applicable: no R3 or production action.
