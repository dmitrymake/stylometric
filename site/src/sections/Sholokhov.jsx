      ...
      <div className="wrap flow">
        ...
        <div className="reveal module">
          ...
          <p className="prose muted" style={{ maxWidth: "68ch", marginBottom: 22 }}>
            ...
            Дона»</strong> (только бесспорные рассказы и поздняя проза) и{" "}
        ...
        <div className="reveal module">
          ...
          <p className="prose muted" style={{ maxWidth: "66ch", marginBottom: 20 }}>
            ...
            потому что оба пишут <em>один и тот же</em> донской мир: у бесспорных «Донских рассказов»
            Шолохова ближайший после самого автора — снова Крюков ({fmtScore(THEM.donskie[1][1])}), но следом
          ...
          <TestSummary>
            ...
            даже бесспорные рассказы самого Шолохова.
          </TestSummary>
          <div className="grid cols-2" style={{ gap: 22 }}>
            ...
            <Card padding={22}>
              ...
              <p className="muted" style={{ fontSize: 12.5, marginTop: 12 }}>
                Бесспорный Шолохов тоже почти упирается в Крюкова — донская тема роднит всех.
              </p>
            </Card>
          </div>
          ...
          <div className="split" style={{ marginTop: 28, alignItems: "center" }}>
            <div className="prose">
              ...
              <p>
                Это видно по тому, что собственные бесспорные «Донские рассказы» Шолохова тоже стоят к
          ...
          <div className="split" style={{ alignItems: "start", marginTop: 18 }}>
            <div>
              ...
              <p className="muted" style={{ fontSize: 12, margin: "0 0 12px" }}>
                ...
                автора. Строгий тест без этого круга — в вердикте (там первый том «Тихого Дона» уже спорный).
              </p>
          ...
          <div className="split" style={{ alignItems: "start" }}>
            ...
            <div style={{ display: "grid", gap: 12, alignContent: "start" }}>
              ...
              <p className="callout" style={{ margin: 0 }}>
                ...
                ({RIGOR.caEnsTdBooks[0].p}), кн.4 — ничья ({RIGOR.caEnsTdBooks[3].p}). В покнижной проверке без замкнутого круга
        ...
        <div className="reveal module">
          ...
          <div className="split" style={{ alignItems: "start" }}>
            <div className="prose">
              ...
              <p className="verdict">
                <strong style={{ color: "var(--text)" }}>За Шолохова — ключевой тест без замкнутого круга.</strong>{" "}
                Проверка по целым книгам, где все спорные тома и донские контроли разом вынуты из обучения (опора — лишь
                бесспорные одиночные работы), относит <strong style={{ color: "var(--success)" }}>{RIGOR.loboTd.tdAttrib} тома → Шолохову</strong>{" "}
                при нулевой доле ложных срабатываний на донских контролях. Против «много рук» — попарная проверка авторства
              ...
              <p className="muted" style={{ fontSize: 12.5, marginTop: 0 }}>
                ...
                картина нескольких независимых тестов без замкнутого круга.
              </p>
              <p>
              ...
              <p className="muted">
                ...
                контроля и проверки замкнутого круга эталона. Здесь эти претензии закрыты явными тестами: проверка по
                целым книгам без замкнутого круга и без утечки, нулевой фон ложных срабатываний на донских контролях,
