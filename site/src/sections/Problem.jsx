...
const TRAPS = [
  {
    ...
    fix: "Решение: прятать не только саму книгу, но и все сборники и издания с тем же содержанием. Тогда знакомый рассказ не сможет подсказать собственное имя.",
  },
  {
    num: "02",
  ...
  },
  {
    ...
    fix: "Рядом с результатом нужны правила экзамена, оценка разброса и простые соперники для сравнения. Если «мешок слов» справляется так же, сложная модель не нужна.",
  },
];
