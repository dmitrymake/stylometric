...
export const CORPUS = {
  ...
  benchmark: {
    ...D.corpus.benchmark,
    label: "первый эксперимент · полная выборка",
    cv: "проверка по книгам, пять частей",
  },
  ...
  pd: { ...D.corpus.pd, label: "первый эксперимент · открытая выборка" },

  // Исторический отозванный headline-срез: полный per-book LOBO.
  // 47 в обучаемом пуле / 43 тестированных / 251 книга.
  lobo: { ...D.corpus.lobo, label: "первый эксперимент · по целым книгам" },
};
